 ...
 * @returns {{tar: boolean, gzip: boolean, gzipOptions: Object, dotFiles: boolean, emptyFiles: boolean, emptyDirs: boolean, transformStreams: stream.Transform[] }}
 */
...
module.exports = class ArtifactTask {
     ...
     * @param {stream.Transform[]} [settings.transformStreamss] The array of transform streams.
     */
