...
const TransformStream = require('../streams/transform-stream');
...
const writeArtifact = (artifactTask) => {
    ...
    const transformStream = new TransformStream(artifactSettings.transform);
 ...
 * @param {Function} [options.transform=null] Transform function for manipulate chunks.
 * @returns {Promise}
 */
