...
module.exports = function (artifact, options, callback) {
    ...
    mkdirp(dir, err => {
        ...
        const writeStream = artifact.tar
            ? new TarStream(dest, { gzip: artifact.gzip, emptyFiles: options.emptyFiles, emptyDirs: options.emptyDirs })
            : new CopyStream(dest, { emptyFiles: options.emptyFiles, emptyDirs: options.emptyDirs });
