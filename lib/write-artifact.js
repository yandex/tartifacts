...
module.exports = function (artifact, options, callback) {
    ...
    mkdirp(dir, err => {
        ...
        const writeStream = artifact.tar
            ? new TarArtifactStream(dest, { gzip: artifact.gzip, emptyFiles: options.emptyFiles, emptyDirs: options.emptyDirs })
            : new CopyArtifactStream(dest, { emptyFiles: options.emptyFiles, emptyDirs: options.emptyDirs });
