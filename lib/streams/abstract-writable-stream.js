...
module.exports = class AbstractWritableStream extends stream.Writable {
     ...
     *
     * @param {{path: string, relative: string, base: string, cwd: string, stats: fs.Stats, history: string[], subdir: string}} file — the file info.
     * @param {function} callback — call this function when processing is complete.
     * @abstract
     */
    // eslint-disable-next-line class-methods-use-this
     ...
     *
     * @param {{path: string, base: string, cwd: string, history: string[], subdir: string}} chunk — the file to be added in artifact.
